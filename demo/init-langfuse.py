...
Waits for Langfuse to be ready, then:
  1. Creates admin account (raj@lab.local / <from LANGFUSE_ADMIN_PASSWORD env>)
...
PASSWORD = os.environ.get("LANGFUSE_ADMIN_PASSWORD", "")
if not PASSWORD:
    raise ValueError("LANGFUSE_ADMIN_PASSWORD env var is required")
...
print("  LANGFUSE_INIT_USER_PASSWORD=<from vault>")
print()
